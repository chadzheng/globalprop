angular.module("ngMap", []),
                    ...
                    getOptions = function(e, t) {
                        ...
                        for (var o in e)
                            if (e[o]) {
                                ...
                                n[o] = "string" != typeof e[o] ? e[o] : toOptionValue(e[o], {
                                    scope: t,
                                    key: o
                                })
                            }
    ...
    function() {
        ...
        angular.module("ngMap").directive("customControl", ["Attr2Options", "$compile", function(e, t) {
            ...
            return {
                ...
                require: "^map",
                link: function(e, o, i, r) {
                    var a = (n.orgAttributes(o), n.filter(i)),
                        s = n.getOptions(a, e),
                        c = n.getEvents(e, a),
    ...
    function() {
        ...
        var e, t, n, o = function(e) {
                ...
                o.prototype = new google.maps.OverlayView, o.prototype.setContent = function(e, o) {
                    ...
                    if (e && (this.position = e), this.getProjection() && "function" == typeof this.position.lng) {
                        var t = this.getProjection().fromLatLngToDivPixel(this.position),
                            n = Math.round(t.x - this.el.offsetWidth / 2),
                            o = Math.round(t.y - this.el.offsetHeight - 10);
                    ...
                    var t = this.el.className.split(" "); - 1 == t.indexOf(e) && t.push(e), this.el.className = t.join(" ")
            ...
            r = function(r, a, s) {
                return e = r, t = a, n = s, i(), {
                    restrict: "E",
                    require: "^map",
                    link: function(t, n, i, r) {
                        var a = (e.orgAttributes(n), e.filter(i)),
                            s = e.getOptions(a, t),
                            c = e.getEvents(t, a),
                            u = n[0].parentElement.removeChild(n[0]),
                            l = new o(s);
        ...
        var e = function(e, t) {
            ...
            t = function(t, n, o) {
                var i = t,
                    ...
                    s = function(t, o, r, s) {
                        var c = i.orgAttributes(o),
                            u = i.filter(r),
                            l = i.getOptions(u),
                            p = i.getEvents(t, u),
                            g = i.getAttrsToObserve(c),
                            d = e(l, p);
        ...
        angular.module("ngMap").directive("drawingManager", ["Attr2Options", function(e) {
            ...
            return {
                ...
                link: function(e, n, o, i) {
                    var r = (t.orgAttributes(n), t.filter(o)),
                        a = t.getOptions(r),
            ...
            var i = e,
                ...
                a = function(e, t, n, a) {
                    ...
                    s && a.getGeoLocation(s).then(function(t) {
                        ...
                        var i = a.map.infoWindows[n],
                            r = o ? o : this.getPosition ? this : null;
                        i.__open(a.map, e, r)
    ...
    function() {
        ...
        var e, t, n, o, i = function(n, i, r) {
            ...
            r = function(e, t) {
                return !t.mapLazyLoad && void 0, o = e.html(), n = t.mapLazyLoad, document.querySelector('script[src="' + n + (n.indexOf("?") > -1 ? "&" : "?") + 'callback=lazyLoadCallback"]') ? !1 : (e.html(""), {
                    pre: i
                })
            },
            a = function(n, o) {
        ...
        var e = function(e) {
            ...
            t = function(t, n) {
                ...
                if (delete t.name, t.icons)
                    for (var r = 0; r < t.icons.length; r++) {
                        var a = t.icons[r];
    ...
    function() {
        ...
        var e = function(e) {
            var t = e,
                ...
                o = function(e, o, i) {
                    var r = (t.orgAttributes(o), t.filter(i)),
                        a = t.getOptions(r),
                        s = t.getControlOptions(r),
